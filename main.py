...
class GeneratorPage:
  ...
  def get_sliderxvalue(self,x):
    ...
    if type(self.currenton_widget)==CTkCheckBox:
      self.currenton_widget.configure(checkbox_width=int(self.sliderw.get())*16.6)
    else:
  ...
  def get_slideryvalue(self,x):
    ...
    if type(self.currenton_widget)==CTkCheckBox:
      self.currenton_widget.configure(checkbox_height=int(self.sliderl.get())*16.6)
    else:
  ...
  def widget_button_page1(self):
    ...
    self.sidebar_button_4 = CTkButton(self.sidebar_frame, text="CheckBox", corner_radius=15,height=50,command=self.addcheckbox)
    self.sidebar_button_4.pack(pady=10, padx=20)

    self.sidebar_button_5 = CTkButton(self.sidebar_frame, text="ComboBox", corner_radius=15,height=50,command=self.addcombobox)
    self.sidebar_button_5.pack(pady=10, padx=20)

    self.sidebar_button_6 = CTkButton(self.sidebar_frame, text="Entry", corner_radius=15,height=50,command=self.addentry)
    self.sidebar_button_6.pack(pady=10, padx=20)

    self.sidebar_button_7 = CTkButton(self.sidebar_frame, text="OptionMenu", corner_radius=15,height=50,command=self.addoptionmenu)
    self.sidebar_button_7.pack(pady=10, padx=20)

    self.sidebar_button_8 = CTkButton(self.sidebar_frame, text="ProgressBar", corner_radius=15,height=50,command=self.addprogressbar)
    self.sidebar_button_8.pack(pady=10, padx=20)

    self.sidebar_button_9 = CTkButton(self.sidebar_frame, text="RadioButton", corner_radius=15,height=50,command=self.addradiobutton)
  ...
  def changefont(self,v):
    ...
    if self.font_style.get().lower()!="none":
      if self.font_style.get()=="Bold":
        currentfont=CTkFont(family=v,size=int(self.font_size.get()),weight=self.font_style.get().lower())
        self.currenton_widget.configure(font=currentfont)
      elif self.font_style.get()=="Italic":
        currentfont=CTkFont(family=v,size=int(self.font_size.get()),slant=self.font_style.get().lower())
        self.currenton_widget.configure(font=currentfont)
      elif self.font_style.get()=="Underline":
        currentfont=CTkFont(family=v,size=int(self.font_size.get()),underline=True)
        self.currenton_widget.configure(font=currentfont)
    else:
      currentfont=CTkFont(family=v,size=int(self.font_size.get()))
      self.currenton_widget.configure(font=(currentfont))
